...
var tncode = {
    ...
    _send_result: function () {
        ...
        var re = new _ajax();
        var phpsession = this.getCookie('PHPSESSID');
        re.request('get', 'check_captcha?PHPSESSID=' + phpsession + '&tn_r=' + tncode._mark_offset, haddle);
    ...
    refresh: function () {
        ...
        var img_url = "captcha?t=" + Math.random();
